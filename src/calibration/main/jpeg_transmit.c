/* ESP32 JPEG Image UDP Streaming
 *
 * This file is used to visualize the frame of multiple cameras by changing
 * CAM_ID and receiving UDP packets sent from each ESP32-CAM 
 * 
